...
var app = {
   ...
   initPaymentUI : function () {
     var clientIDs = {
       ...
       "PayPalEnvironmentSandbox": "ASvtjtfnK1909CozM6wDe_8FDby1YMOQGdYcUbF5hEGeKm1leZ4XMhI5muW368SRy-3QtnxwZTbrQs1H"
     };
   ...
   createPayment : function () {
     ...
     var payment = new PayPalPayment("10.00", "USD", "Dignity Dreams", "Sale", paymentDetails);
     return payment;
   },
   ...
   onPrepareRender : function() {
     ...
     cardScanBtn.onclick = function(e) {
        alert("Card scan button clicked");
